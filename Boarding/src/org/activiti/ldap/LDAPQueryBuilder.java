...
public class LDAPQueryBuilder {
  ...
  public String buildQueryByUserId(LDAPConfigurator ldapConfigurator, String userId) {
	...
	System.out.println("::: buildQueryByUserId ::: ");

    if (ldapConfigurator.getQueryUserByUserId() != null) {
    	System.out.println("::: ldapConfigurator.getQueryUserByUserId()  is not null ::: " + ldapConfigurator.getQueryUserByUserId());

      searchExpression = MessageFormat.format(ldapConfigurator.getQueryUserByUserId(), userId);
  	System.out.println("::: searchExpression ::: " +searchExpression);

    } else {
    	System.out.println("::: ldapConfigurator.getQueryUserByUserId()  is null ::: ");
